...
typical number formats.. format has the following type: lists containing elements 'locale', 'nully', 'prefix', 'specifier'.
Those elements have the following types:
  - `locale` (optional): . locale has the following type: lists containing elements 'symbol', 'decimal', 'group', 'grouping', 'numerals', 'percent', 'separate_4digits'.
Those elements have the following types:
  - `symbol` (Array of Strings; optional)
  - `decimal` (String; optional)
  - `group` (String; optional)
  - `grouping` (Array of Reals; optional)
  - `numerals` (Array of Strings; optional)
  - `percent` (String; optional)
  - `separate_4digits` (Bool; optional)
  - `nully` (Bool | Real | String | Dict | Array; optional)
  - `prefix` (Real; optional)
...
The `id` is not visible in the table.
  - `name` (String | Array of Strings; required): The `name` of the column,
...
'failure' (default 'reject'): what to do with the value if the action fails:
 ...
 reject: do not modify the existing value.. on_change has the following type: lists containing elements 'action', 'failure'.
Those elements have the following types:
...
'allow_YY': `datetime` columns only, allow 2-digit years (default: false).
  ...
  `action: 'coerce'`, will convert user input to a 4-digit year.. validation has the following type: lists containing elements 'allow_null', 'default', 'allow_YY'.
Those elements have the following types:
  - `allow_null` (Bool; optional)
  - `default` (Bool | Real | String | Dict | Array; optional)
  - `allow_YY` (Bool; optional)
...
When left unspecified, each individual nested prop will default to a pre-determined value.
  ...
  'numerals': a list of ten strings used as replacements for numbers 0-9.
  'percent': (default: '%') the string used for the percentage symbol.
  'separate_4digits': (default: True) separate integers with 4-digits or less.. locale_format has the following type: lists containing elements 'symbol', 'decimal', 'group', 'grouping', 'numerals', 'percent', 'separate_4digits'.
Those elements have the following types:
  - `symbol` (Array of Strings; optional)
  - `decimal` (String; optional)
  - `group` (String; optional)
...
View the documentation examples to learn more.. fixed_columns has the following type: lists containing elements 'headers', 'data'.
Those elements have the following types:
  - `headers` (a value equal to: false; optional)
  - `data` (a value equal to: 0; optional) | lists containing elements 'headers', 'data'.
Those elements have the following types:
...
underlying markup of the table and may impact the
way that your columns are rendered or sized.
View the documentation examples to learn more.. fixed_rows has the following type: lists containing elements 'headers', 'data'.
Those elements have the following types:
  - `headers` (a value equal to: false; optional)
  - `data` (a value equal to: 0; optional) | lists containing elements 'headers', 'data'.
Those elements have the following types:
  - `headers` (a value equal to: true; required)
  - `data` (Real; optional)
- `column_selectable` (a value equal to: 'single', 'multi', false; optional): If `single`, then the uer can select a single column or group
...
that case.. tooltip has the following type: Dict with Strings as keys and values of type lists containing elements 'delay', 'duration', 'type', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
...
during which the tooltip is shown when hovering a cell.
This overrides the table's `tooltip_duration` property.
If set to `null`, the tooltip will not disappear.. tooltip_conditional has the following type: Array of lists containing elements 'delay', 'duration', 'if', 'type', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
  - `duration` (Real; optional)
  - `if` (required): . if has the following type: lists containing elements 'column_id', 'filter_query', 'row_index'.
Those elements have the following types:
  - `column_id` (String; optional)
  - `filter_query` (String; optional)
  - `row_index` (Real | a value equal to: 'odd', 'even'; optional)
  - `type` (a value equal to: 'text', 'markdown'; optional)
...
Alternatively, the value of the property can also be
a plain string. The `text` syntax will be used in
that case.. tooltip_data has the following type: Array of Dict with Strings as keys and values of type String | lists containing elements 'delay', 'duration', 'type', 'value'.
Those elements have the following types:
  - `delay` (Real; optional)
  - `duration` (Real; optional)
  - `type` (a value equal to: 'text', 'markdown'; optional)
